...
public class KHClothArrowEntityRenderer extends ProjectileEntityRenderer<KHClothArrowEntity> {
    public KHClothArrowEntityRenderer(EntityRendererFactory.Context context) {
        super(context);
    }

    public Identifier getTexture(KHClothArrowEntity arrowEntity) {
