...
public class CloseHelmClosed extends HumanoidModel<LivingEntity> {
	...
	public static LayerDefinition getTexturedModelData() {
        ...
        PartDefinition visor = armorHead.addOrReplaceChild("visor", CubeListBuilder.create().texOffs(83, 16).addBox(-4.0F, -31.75F, -3.9F, 8.0F, 3.0F, 4.0F, new CubeDeformation(0.65F)), PartPose.offset(0.0F, 24.0F, 0.0F));
        ...
        visor.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(82, 36).addBox(-4.5F, -4.2041F, -2.0319F, 9.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -29.75F, -2.5F, 2.0508F, 0.0F, 0.0F));

        visor.addOrReplaceChild("armet_2_r1", CubeListBuilder.create().texOffs(80, 50).addBox(-4.5F, -1.9514F, -2.6152F, 9.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -29.75F, -2.5F, -0.2182F, 0.0F, 0.0F));
