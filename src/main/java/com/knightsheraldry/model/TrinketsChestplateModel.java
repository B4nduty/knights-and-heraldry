...
public class TrinketsChestplateModel extends BipedEntityModel<LivingEntity> {
	...
	private final ModelPart aventail;
	...
	public TrinketsChestplateModel(ModelPart root) {
		...
		this.aventail = armorBody.getChild("aventail");
	...
	protected Iterable<ModelPart> getBodyParts() {
		return ImmutableList.of(this.armorBody, this.aventail, this.armorRightArm, this.armorLeftArm);
	}

	public static TexturedModelData getTexturedModelData() {
		ModelData modelData = BipedEntityModel.getModelData(Dilation.NONE, 0f);
		ModelPartData modelPartData = modelData.getRoot();
		ModelPartData armorBody = modelPartData.addChild("armorBody", ModelPartBuilder.create().uv(80, 32).cuboid(-4.0F, 0.0F, -2.0F, 8.0F, 10.0F, 4.0F, new Dilation(0.4F)), ModelTransform.pivot(0.0F, 0.0F, 0.5F));
		...
		armorBody.addChild("aventail", ModelPartBuilder.create().uv(93, 112).cuboid(-5.0F, -24.0F, -2.8F, 10.0F, 4.0F, 6.0F, new Dilation(0.65F)), ModelTransform.pivot(0.0F, 24.0F, -0.5F));
