...
public class HorseBardingModel<T extends AbstractHorseEntity> extends AnimalModel<T> {
	...
	public HorseBardingModel(ModelPart root) {
		...
		this.headpiece = this.head.getChild("headpiece");
		this.body = root.getChild("body");
		this.saddle = this.body.getChild("saddle");
	}

	public Iterable<ModelPart> getHeadParts() {
		return ImmutableList.of(this.head, this.mouth, this.left_ear, this.right_ear, this.neck, this.mane, this.headpiece);
	}

	@Override
	protected Iterable<ModelPart> getBodyParts() {
		return ImmutableList.of(this.body, this.saddle);
	}

	public static TexturedModelData getTexturedModelData() {
		ModelData modelData = new ModelData();
		ModelPartData modelPartData = modelData.getRoot();
		ModelPartData headArmor = modelPartData.addChild("head", ModelPartBuilder.create().uv(0, 13).cuboid(-3.0F, -11.0F, -2.0F, 6.0F, 5.0F, 7.0F, new Dilation(0.1F)), ModelTransform.pivot(0.0F, 2.0F, -9.0F));
		...
		headArmor.addChild("mouth", ModelPartBuilder.create().uv(0, 25).cuboid(-2.0F, -11.0F, -7.2F, 4.0F, 5.0F, 5.0F, new Dilation(0.1F)), ModelTransform.pivot(0.0F, 0.0F, 0.0F));

		headArmor.addChild("left_ear", ModelPartBuilder.create().uv(19, 16).cuboid(0.55F, -13.0F, 4.0F, 2.0F, 3.0F, 1.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, -1.0F, -0.01F));

		headArmor.addChild("right_ear", ModelPartBuilder.create().uv(19, 16).cuboid(-2.55F, -13.0F, 4.0F, 2.0F, 3.0F, 1.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, -1.0F, -0.01F));

		headArmor.addChild("neck", ModelPartBuilder.create().uv(0, 33).cuboid(-2.05F, -6.0F, -2.0F, 4.0F, 12.0F, 7.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 0.0F, 0.0F));

		headArmor.addChild("mane", ModelPartBuilder.create().uv(56, 36).cuboid(-1.0F, -11.0F, 5.01F, 2.0F, 16.0F, 2.0F, new Dilation(0.1F)), ModelTransform.pivot(0.0F, 0.0F, -0.01F));

		headArmor.addChild("headpiece", ModelPartBuilder.create().uv(30, 68).cuboid(-0.5F, -14.0F, -0.5F, 1.0F, 2.0F, 1.0F, new Dilation(0.0F))
