...
public class HelmetDecoModel extends BipedEntityModel<LivingEntity> {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData armorHead = modelPartData.addChild("armorHead", ModelPartBuilder.create().uv(0, 43).cuboid(0.0F, -24.0F, -11.0F, 0.0F, 22.0F, 22.0F, new Dilation(0.0F))
		.uv(45, 88).cuboid(-11.0F, -24.0F, 0.0F, 22.0F, 22.0F, 0.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 0.0F, 0.0F));
		...
		.uv(45, 43).cuboid(0.0F, -46.0F, -11.0F, 0.0F, 22.0F, 22.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 22.0F, 0.0F, 0.0F, -0.7854F, 0.0F));
