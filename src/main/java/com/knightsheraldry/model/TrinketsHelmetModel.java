...
public class TrinketsHelmetModel extends BipedEntityModel<LivingEntity> {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData great_bascinet = armorHead.addChild("great_bascinet", ModelPartBuilder.create().uv(93, 112).cuboid(-5.0F, 0.0F, -3.3F, 10.0F, 4.0F, 6.0F, new Dilation(0.66F)), ModelTransform.pivot(0.0F, 0.0F, 0.0F));
