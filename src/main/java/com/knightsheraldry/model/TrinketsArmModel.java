...
public class TrinketsArmModel extends BipedEntityModel<LivingEntity> {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		armorLeftArm.addChild("left_plate_rim_r1", ModelPartBuilder.create().uv(112, 18).mirrored().cuboid(1.0F, -5.0F, -3.5F, 0.0F, 4.0F, 7.0F, new Dilation(0.0F)).mirrored(false), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.2618F));

		armorLeftArm.addChild("left_besagew_r1", ModelPartBuilder.create().uv(116, 45).mirrored().cuboid(-2.0F, 0.0F, -4.3F, 3.0F, 3.0F, 2.0F, new Dilation(0.0F)).mirrored(false), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.0F, -0.3491F, 0.0F));
