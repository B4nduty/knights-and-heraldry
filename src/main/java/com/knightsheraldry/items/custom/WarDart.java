...
public class WarDart extends KHWeapons {
        ...
        if (user instanceof PlayerEntity playerEntity) {
            ...
            if (i >= 10 && !world.isClient) {
                ...
                if (!playerEntity.getAbilities().creativeMode) {
                    ...
                    playerEntity.getItemCooldownManager().set(this, KnightsHeraldry.CONFIG.configs.getWardartThrowCooldown() * 20);
                }
            }
        }
    }
    ...
    public void appendTooltip(ItemStack stack, @Nullable World world, List<Text> tooltip, TooltipContext context) {
        tooltip.add(Text.translatable("tooltip.knightsheraldry.throw-to-stun"));
    }
}