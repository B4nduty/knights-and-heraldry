...
public class Hammer extends SwordItem implements SCWeapon {
    ...
    public float[] getAttackDamageValues() {
        return new float[] {
                0.0F, //Slashing
                KnightsHeraldry.getConfig().getHammerDamagePiercing(),
                KnightsHeraldry.getConfig().getHammerDamageBludgeoning()
        };
    }
