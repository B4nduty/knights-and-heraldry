...
public class KHHelmetTrinkets extends TrinketItem implements KHTrinketsItem {
    double armor;
    double toughness;
    double hungerDrainAddition;

    public KHHelmetTrinkets(Settings settings, double armor, double toughness, double hungerDrainAddition) {
        super(settings);
        this.armor = armor;
    ...
    public BipedEntityModel<LivingEntity> getModel() {
        return new TrinketsHelmetModel(TrinketsHelmetModel.getTexturedModelData().createModel());
    }
