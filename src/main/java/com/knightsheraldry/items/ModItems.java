...
public class ModItems {
    ...
    public static final RegistrySupplier<Item> BARBUTE_NO_VISOR = ITEMS.register("barbute_no_visor", () ->
            new KHHelmetAccessory(new Item.Settings().maxCount(1).maxDamage(84), false, Ingredient.ofItems(Items.IRON_INGOT)));
    ...
    public static final RegistrySupplier<Item> GREAT_HELM = ITEMS.register("great_helm", () ->
            new KHHelmetAccessory(new Item.Settings().maxCount(1).maxDamage(132), false, Ingredient.ofItems(Items.IRON_INGOT)));
    ...
    public static final RegistrySupplier<Item> FROGMOUTH = ITEMS.register("frogmouth", () ->
            new KHHelmetAccessory(new Item.Settings().maxCount(1).maxDamage(180), false, Ingredient.ofItems(Items.IRON_INGOT)));
