...
public class ModItemGroups {
    ...
    private static void armors(ItemGroup.DisplayContext ctx, ItemGroup.Entries stacks) {
        stacks.addAll(List.of(
                ...
                stack(ModItems.MAXIMILLIAN_CUIRASS),
                stack(ModItems.MAXIMILLIAN_CUIRASS_TASSETS),
                stack(ModItems.XIIII_PLATE_CUIRASS),
                stack(ModItems.XIIII_PLATE_CUIRASS_TASSETS),
                stack(ModItems.XIIII_PLATE_BREASTPLATE),
                stack(ModItems.BARBUTE_NO_VISOR),
                stack(ModItems.BASCINET_NO_VISOR),
                stack(ModItems.KETTLE_HELM),
                stack(ModItems.NASAL_HELM),
                stack(ModItems.VIKING_HELM),
                stack(ModItems.ARMET),
                stack(ModItems.ARMET_2),
                stack(ModItems.BARBUTE),
                stack(ModItems.BASCINET),
                stack(ModItems.CAGE),
                stack(ModItems.CAGE_2),
                stack(ModItems.FLAT_BASCINET),
                stack(ModItems.GREAT_HELM),
                stack(ModItems.GREAT_HELM_2),
                stack(ModItems.SALLET),
                stack(ModItems.FROGMOUTH),
                stack(ModItems.GREAT_ARMET),
                stack(ModItems.GREAT_ARMET_2),
                stack(ModItems.GREAT_BASCINET),
                stack(ModItems.GREAT_HOUNDSKUL_BASCINET),
                stack(ModItems.MAXIMILLIAN_HELMET),
                stack(ModItems.GAUNTLET),
                stack(ModItems.BRIGANDINE_REREBRACE),
                stack(ModItems.PLATE_REREBRACE),
