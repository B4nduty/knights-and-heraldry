...
public class ModItemGroups {
    ...
    private static void armors(ItemGroup.DisplayContext ctx, ItemGroup.Entries stacks) {
        stacks.addAll(List.of(
                ...
                armorStack(ModItems.BARBUTE_NO_VISOR.get(),false, false),
                armorStack(ModItems.BASCINET_NO_VISOR.get(),false, false),
                ...
                armorStack(ModItems.FLAT_BASCINET.get(),false, false),
                ...
                armorStack(ModItems.MAIL_PAULDRON.get(),false, false),
                armorStack(ModItems.BRIGANDINE_PAULDRON.get(),false, false),
                armorStack(ModItems.PLATE_PAULDRON.get(),false, false),
                armorStack(ModItems.MAIL_PAULDRON.get(),false, true),
                armorStack(ModItems.BRIGANDINE_PAULDRON.get(),false, true),
                armorStack(ModItems.PLATE_PAULDRON.get(),false, true),
