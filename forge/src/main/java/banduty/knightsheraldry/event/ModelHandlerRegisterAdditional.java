...
public class ModelHandlerRegisterAdditional {
    @SubscribeEvent
    public static void onRegisterAdditionalModels(ModelEvent.RegisterAdditional event) {
        ...
        // Banner Patterns
        String[] bannerCompatibleNames = {"surcoat", "surcoat_sleeveless"};
        ...
        for (String baseName : bannerCompatibleNames) {
            for (String patternName : bannerPatternNames) {
                event.register(new ModelResourceLocation(KnightsHeraldry.MOD_ID, baseName + "/" + patternName, "inventory"));
            }
        }
    }
}