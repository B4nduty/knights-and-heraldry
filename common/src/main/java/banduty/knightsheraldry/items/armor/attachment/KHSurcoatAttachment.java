...
public class KHSurcoatAttachment extends Item implements ArmorAttachment, ArmorAttachmentRenderProvider {
    ...
    public KHSurcoatAttachment(Properties properties, Ingredient ingredient) {
        super(properties);
    ...
    public KHSurcoatAttachment(Properties properties, int defaultColor, Ingredient ingredient) {
        super(properties);
        this.ingredient = ingredient;
        this.hasOverlay = false;
    ...
    public KHSurcoatAttachment(Properties properties, boolean overlay, int defaultColor, Ingredient ingredient) {
        super(properties);
        this.ingredient = ingredient;
