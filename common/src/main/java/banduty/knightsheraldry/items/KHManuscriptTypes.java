...
public enum KHManuscriptTypes implements ManuscriptType {
    ...
    BARBUTE("barbute", KHItems.MANUSCRIPT_BARBUTE, KHItems.BARBUTE_PIECE, KHItems.TONGS_BARBUTE),
    BASCINET("bascinet", KHItems.MANUSCRIPT_BASCINET, KHItems.BASCINET_PIECE, KHItems.TONGS_BASCINET),
    KETTLE("kettle", KHItems.MANUSCRIPT_KETTLE, KHItems.KETTLE_PIECE, KHItems.TONGS_KETTLE),
    NASAL("nasal", KHItems.MANUSCRIPT_NASAL, KHItems.NASAL_PIECE, KHItems.TONGS_NASAL),
    BURGONET("burgonet", KHItems.MANUSCRIPT_BURGONET, KHItems.BURGONET_PIECE, KHItems.TONGS_BURGONET),
    SALLET("sallet", KHItems.MANUSCRIPT_SALLET, KHItems.SALLET_PIECE, KHItems.TONGS_SALLET),
    MORION("morion", KHItems.MANUSCRIPT_MORION, KHItems.MORION_PIECE, KHItems.TONGS_MORION),
    ARMET("armet", KHItems.MANUSCRIPT_ARMET, KHItems.ARMET_PIECE, KHItems.TONGS_ARMET),
    CAGE("cage", KHItems.MANUSCRIPT_CAGE, KHItems.CAGE_PIECE, KHItems.TONGS_CAGE),
    GREAT_HELMET("great_helmet", KHItems.MANUSCRIPT_GREAT_HELMET, KHItems.GREAT_HELMET_PIECE, KHItems.TONGS_GREAT_HELMET),
    CLOSE_HELMET("close_helmet", KHItems.MANUSCRIPT_CLOSE_HELMET, KHItems.CLOSE_HELMET_PIECE, KHItems.TONGS_CLOSE_HELMET),
    FROGMOUTH("frogmouth", KHItems.MANUSCRIPT_FROGMOUTH, KHItems.FROGMOUTH_PIECE, KHItems.TONGS_FROGMOUTH),
    MAXIMILIAN("maximilian", KHItems.MANUSCRIPT_MAXIMILIAN, KHItems.MAXIMILIAN_PIECE, KHItems.TONGS_MAXIMILIAN),
    VISOR("visor", KHItems.MANUSCRIPT_VISOR, KHItems.VISOR_PIECE, KHItems.TONGS_VISOR),
    FALLING_BUFFE("falling_buffe", KHItems.MANUSCRIPT_FALLING_BUFFE, KHItems.FALLING_BUFFE_PIECE, KHItems.TONGS_FALLING_BUFFE),
    BEVOR("bevor", KHItems.MANUSCRIPT_BEVOR, KHItems.BEVOR_PIECE, KHItems.TONGS_BEVOR);
