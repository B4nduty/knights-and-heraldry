...
public class ArquebusModel extends GeoModel<Arquebus> {
    ...
    public ResourceLocation getModelResource(Arquebus animatable) {
        return ResourceLocation.fromNamespaceAndPath(KnightsHeraldry.MOD_ID, "geo/arquebus.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(Arquebus animatable) {
        return ResourceLocation.fromNamespaceAndPath(KnightsHeraldry.MOD_ID, "textures/item/arquebus.png");
    }

    @Override
    public ResourceLocation getAnimationResource(Arquebus animatable) {
        return ResourceLocation.fromNamespaceAndPath(KnightsHeraldry.MOD_ID, "animations/arquebus.animation.json");
    }
}