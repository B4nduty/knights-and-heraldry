...
public class KHCloseHelmetAttachmentRenderer implements ArmorAttachmentRenderer {
    @Override
    public void render(PoseStack poseStack, MultiBufferSource multiBufferSource, int i, LivingEntity livingEntity,
        ...
        if (!(itemStack.getItem() instanceof KHCloseHelmet khCloseHelmet)) return;
        if (khCloseHelmet.hasOpenVisor(itemStack)) {
