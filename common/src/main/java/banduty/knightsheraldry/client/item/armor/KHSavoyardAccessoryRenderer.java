...
public class KHSavoyardAccessoryRenderer implements AccessoryRenderer {
    @Override
    public void render(PoseStack poseStack, MultiBufferSource bufferSource, int packedLight, LivingEntity entity, ItemStack accessoryStack, HumanoidModel<LivingEntity> contextModel) {
        ...
        if (!(accessoryStack.getItem() instanceof KHSavoyard khSavoyard)) return;
        if (khSavoyard.hasOpenVisor(accessoryStack)) {
