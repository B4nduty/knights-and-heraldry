...
public class Sallet extends HumanoidModel<LivingEntity> {
	private final ModelPart armorHead;

	public Sallet(ModelPart root) {
		super(root);
	...
	public static LayerDefinition getTexturedModelData() {
		...
		.texOffs(0, 0).addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.6F)), PartPose.offset(0.0F, 0.0F, 0.0F));
		...
		PartDefinition sallet_4_r3 = bevor.addOrReplaceChild("sallet_4_r3", CubeListBuilder.create().texOffs(90, 42).addBox(-4.0F, -1.0F, 0.0F, 4.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 1.2F, -5.9F, 0.0F, 0.3054F, 0.0F));
		...
		PartDefinition sallet_4_r4 = rotation2.addOrReplaceChild("sallet_4_r4", CubeListBuilder.create().texOffs(70, 25).addBox(-2.7418F, -2.8397F, -2.7418F, 7.0F, 2.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 1.75F, -1.4064F, 0.0F, -0.7854F, 0.0F));
