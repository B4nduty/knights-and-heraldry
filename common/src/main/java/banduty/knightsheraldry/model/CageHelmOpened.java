...
public class CageHelmOpened extends HumanoidModel<LivingEntity> {
	private final ModelPart armorHead;

	public CageHelmOpened(ModelPart root) {
		super(root);
	...
	public static LayerDefinition getTexturedModelData() {
		...
		PartDefinition grid = visor.addOrReplaceChild("grid", CubeListBuilder.create(), PartPose.offsetAndRotation(0.05F, -0.8F, 0.0F, -2.1817F, 0.0F, 0.0F));
