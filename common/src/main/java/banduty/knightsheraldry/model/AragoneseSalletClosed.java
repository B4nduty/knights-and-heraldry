...
public class AragoneseSalletClosed extends HumanoidModel<LivingEntity> {
	...
	public static LayerDefinition getTexturedModelData() {
		...
		PartDefinition visor = sallet.addOrReplaceChild("visor", CubeListBuilder.create().texOffs(83, 16).addBox(-4.0F, -1.75F, -1.9F, 8.0F, 3.0F, 4.0F, new CubeDeformation(0.65F)), PartPose.offset(0.0F, -6.0F, -2.0F));
