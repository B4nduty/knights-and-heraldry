...
public class MorionOpenedModel extends HumanoidModel<LivingEntity> {
	private final ModelPart armorHead;

	public MorionOpenedModel(ModelPart root) {
        super(root);
	...
	public static LayerDefinition getTexturedModelData() {
		...
		PartDefinition bevor = armorHead.addOrReplaceChild("bevor", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, 3.7701F, -6.2481F, 0.3491F, 0.0F, 0.0F));
		...
		PartDefinition bevor2 = armorHead.addOrReplaceChild("bevor2", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, 1.7283F, -6.1072F, 0.9163F, 0.0F, 0.0F));
