...
public class BlackSalletClosed extends HumanoidModel<LivingEntity> {
	...
	public static LayerDefinition getTexturedModelData() {
		...
		PartDefinition helmet = partdefinition.addOrReplaceChild("helmet", CubeListBuilder.create().texOffs(80, 0).addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.6F)), PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition tail_r1 = helmet.addOrReplaceChild("tail_r1", CubeListBuilder.create().texOffs(43, 2).addBox(-2.5F, -2.696F, -2.5F, 5.0F, 5.0F, 5.0F, new CubeDeformation(0.755F)), PartPose.offsetAndRotation(-0.0033F, -4.504F, 3.0884F, 2.6662F, -0.7268F, -2.812F));
