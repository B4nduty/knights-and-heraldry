...
import banduty.knightsheraldry.items.item.khweapon.flail.FlailAnimation;
...
public class Flail extends SwordItem implements GeoItem {
    ...
    private PlayState predicate(AnimationState<banduty.knightsheraldry.items.item.khweapon.flail.Flail> animationState) {
