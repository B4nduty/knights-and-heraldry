...
public interface ModItems {
    ...
    Item BRIGANDINE_SPAULDERS_BESAGEWS = registerItem("brigandine_spaulders_besagews",
            new KHDyeableChestplateAccessory(new Item.Properties().stacksTo(1).defaultDurability(109), true, 10511680, Ingredient.of(Items.IRON_INGOT, Items.LEATHER)));
    Item DARK_BRIGANDINE_SPAULDERS = registerItem("dark_brigandine_spaulders",
    ...
    Item DARK_BRIGANDINE_SPAULDERS_BESAGEWS = registerItem("dark_brigandine_spaulders_besagews",
            new KHDyeableChestplateAccessory(new Item.Properties().stacksTo(1).defaultDurability(120), true, 10511680, Ingredient.of(Items.IRON_INGOT, Items.LEATHER)));
    Item GOLDEN_BRIGANDINE_SPAULDERS = registerItem("golden_brigandine_spaulders",
    ...
    Item GOLDEN_BRIGANDINE_SPAULDERS_BESAGEWS = registerItem("golden_brigandine_spaulders_besagews",
            new KHDyeableChestplateAccessory(new Item.Properties().stacksTo(1).defaultDurability(131), true, 10511680, Ingredient.of(Items.GOLD_INGOT, Items.LEATHER)));
    Item PLATE_SPAULDERS = registerItem("plate_spaulders",
            new KHChestplateAccessory(new Item.Properties().stacksTo(1).defaultDurability(172), Ingredient.of(Items.IRON_INGOT)));
    Item PLATE_SPAULDERS_BESAGEWS = registerItem("plate_spaulders_besagews",
            new KHChestplateAccessory(new Item.Properties().stacksTo(1).defaultDurability(172), Ingredient.of(Items.IRON_INGOT)));
    Item PLATE_SPAULDERS_RIMMED = registerItem("plate_spaulders_rimmed",
            new KHChestplateAccessory(new Item.Properties().stacksTo(1).defaultDurability(172), Ingredient.of(Items.IRON_INGOT)));
    Item PLATE_SPAULDERS_BESAGEWS_RIMMED = registerItem("plate_spaulders_besagews_rimmed",
            new KHChestplateAccessory(new Item.Properties().stacksTo(1).defaultDurability(172), Ingredient.of(Items.IRON_INGOT)));
    Item DARK_PLATE_SPAULDERS = registerItem("dark_plate_spaulders",
            new KHChestplateAccessory(new Item.Properties().stacksTo(1).defaultDurability(189), Ingredient.of(Items.IRON_INGOT)));
    Item DARK_PLATE_SPAULDERS_BESAGEWS = registerItem("dark_plate_spaulders_besagews",
            new KHChestplateAccessory(new Item.Properties().stacksTo(1).defaultDurability(189), Ingredient.of(Items.IRON_INGOT)));
    Item DARK_PLATE_SPAULDERS_RIMMED = registerItem("dark_plate_spaulders_rimmed",
            new KHChestplateAccessory(new Item.Properties().stacksTo(1).defaultDurability(189), Ingredient.of(Items.IRON_INGOT)));
    Item DARK_PLATE_SPAULDERS_BESAGEWS_RIMMED = registerItem("dark_plate_spaulders_besagews_rimmed",
            new KHChestplateAccessory(new Item.Properties().stacksTo(1).defaultDurability(189), Ingredient.of(Items.IRON_INGOT)));
    Item GOLDEN_PLATE_SPAULDERS = registerItem("golden_plate_spaulders",
            new KHChestplateAccessory(new Item.Properties().stacksTo(1).defaultDurability(206), Ingredient.of(Items.GOLD_INGOT)));
    Item GOLDEN_PLATE_SPAULDERS_BESAGEWS = registerItem("golden_plate_spaulders_besagews",
            new KHChestplateAccessory(new Item.Properties().stacksTo(1).defaultDurability(206), Ingredient.of(Items.GOLD_INGOT)));
    Item GOLDEN_PLATE_SPAULDERS_RIMMED = registerItem("golden_plate_spaulders_rimmed",
            new KHChestplateAccessory(new Item.Properties().stacksTo(1).defaultDurability(206), Ingredient.of(Items.GOLD_INGOT)));
    Item GOLDEN_PLATE_SPAULDERS_BESAGEWS_RIMMED = registerItem("golden_plate_spaulders_besagews_rimmed",
            new KHChestplateAccessory(new Item.Properties().stacksTo(1).defaultDurability(206), Ingredient.of(Items.GOLD_INGOT)));

    Item BRIGANDINE = registerItem("brigandine",
    ...
    Item DARK_BRIGANDINE = registerItem("dark_brigandine",
    ...
    Item GOLDEN_BRIGANDINE = registerItem("golden_brigandine",
    ...
    Item BRIG_BREASTPLATE = registerItem("brig_breastplate",
    ...
    Item DARK_BRIG_BREASTPLATE = registerItem("dark_brig_breastplate",
    ...
    Item GOLDEN_BRIG_BREASTPLATE = registerItem("golden_brig_breastplate",
    ...
    Item BRIG_BREASTPLATE_TASSETS = registerItem("brig_breastplate_tassets",
            new KHDyeableChestplateAccessory(new Item.Properties().stacksTo(1).defaultDurability(546), true, 10511680, Ingredient.of(Items.IRON_INGOT, Items.LEATHER)));
    Item DARK_BRIG_BREASTPLATE_TASSETS = registerItem("dark_brig_breastplate_tassets",
            new KHDyeableChestplateAccessory(new Item.Properties().stacksTo(1).defaultDurability(601), true, 10511680, Ingredient.of(Items.IRON_INGOT, Items.LEATHER)));
    Item GOLDEN_BRIG_BREASTPLATE_TASSETS = registerItem("golden_brig_breastplate_tassets",
            new KHDyeableChestplateAccessory(new Item.Properties().stacksTo(1).defaultDurability(655), true, 10511680, Ingredient.of(Items.GOLD_INGOT, Items.LEATHER)));

    Item PLATE_CUIRASS = registerItem("plate_cuirass",
            new KHChestplateAccessory(new Item.Properties().stacksTo(1).defaultDurability(650), Ingredient.of(Items.IRON_INGOT)));
    Item DARK_PLATE_CUIRASS = registerItem("dark_plate_cuirass",
            new KHChestplateAccessory(new Item.Properties().stacksTo(1).defaultDurability(715), Ingredient.of(Items.IRON_INGOT)));
    Item GOLDEN_PLATE_CUIRASS = registerItem("golden_plate_cuirass",
            new KHChestplateAccessory(new Item.Properties().stacksTo(1).defaultDurability(780), Ingredient.of(Items.GOLD_INGOT)));
    Item PLATE_CUIRASS_TASSETS = registerItem("plate_cuirass_tassets",
            new KHChestplateAccessory(new Item.Properties().stacksTo(1).defaultDurability(650), Ingredient.of(Items.IRON_INGOT)));
    Item DARK_PLATE_CUIRASS_TASSETS = registerItem("dark_plate_cuirass_tassets",
            new KHChestplateAccessory(new Item.Properties().stacksTo(1).defaultDurability(715), Ingredient.of(Items.IRON_INGOT)));
    Item GOLDEN_PLATE_CUIRASS_TASSETS = registerItem("golden_plate_cuirass_tassets",
            new KHChestplateAccessory(new Item.Properties().stacksTo(1).defaultDurability(780), Ingredient.of(Items.GOLD_INGOT)));
    Item MAXIMILLIAN_CUIRASS = registerItem("maximillian_cuirass",
            new KHChestplateAccessory(new Item.Properties().stacksTo(1).defaultDurability(650), Ingredient.of(Items.IRON_INGOT)));
    Item DARK_MAXIMILLIAN_CUIRASS = registerItem("dark_maximillian_cuirass",
            new KHChestplateAccessory(new Item.Properties().stacksTo(1).defaultDurability(715), Ingredient.of(Items.IRON_INGOT)));
    Item GOLDEN_MAXIMILLIAN_CUIRASS = registerItem("golden_maximillian_cuirass",
            new KHChestplateAccessory(new Item.Properties().stacksTo(1).defaultDurability(780), Ingredient.of(Items.GOLD_INGOT)));
    Item MAXIMILLIAN_CUIRASS_TASSETS = registerItem("maximillian_cuirass_tassets",
            new KHChestplateAccessory(new Item.Properties().stacksTo(1).defaultDurability(650), Ingredient.of(Items.IRON_INGOT)));
    Item DARK_MAXIMILLIAN_CUIRASS_TASSETS = registerItem("dark_maximillian_cuirass_tassets",
            new KHChestplateAccessory(new Item.Properties().stacksTo(1).defaultDurability(715), Ingredient.of(Items.IRON_INGOT)));
    Item GOLDEN_MAXIMILLIAN_CUIRASS_TASSETS = registerItem("golden_maximillian_cuirass_tassets",
            new KHChestplateAccessory(new Item.Properties().stacksTo(1).defaultDurability(780), Ingredient.of(Items.GOLD_INGOT)));
    Item XIIII_PLATE_CUIRASS = registerItem("xiiii_plate_cuirass",
            new KHChestplateAccessory(new Item.Properties().stacksTo(1).defaultDurability(650), Ingredient.of(Items.IRON_INGOT)));
    Item DARK_XIIII_PLATE_CUIRASS = registerItem("dark_xiiii_plate_cuirass",
            new KHChestplateAccessory(new Item.Properties().stacksTo(1).defaultDurability(715), Ingredient.of(Items.IRON_INGOT)));
    Item GOLDEN_XIIII_PLATE_CUIRASS = registerItem("golden_xiiii_plate_cuirass",
            new KHChestplateAccessory(new Item.Properties().stacksTo(1).defaultDurability(780), Ingredient.of(Items.GOLD_INGOT)));
    Item XIIII_PLATE_CUIRASS_TASSETS = registerItem("xiiii_plate_cuirass_tassets",
            new KHChestplateAccessory(new Item.Properties().stacksTo(1).defaultDurability(650), Ingredient.of(Items.IRON_INGOT)));
    Item DARK_XIIII_PLATE_CUIRASS_TASSETS = registerItem("dark_xiiii_plate_cuirass_tassets",
            new KHChestplateAccessory(new Item.Properties().stacksTo(1).defaultDurability(715), Ingredient.of(Items.IRON_INGOT)));
    Item GOLDEN_XIIII_PLATE_CUIRASS_TASSETS = registerItem("golden_xiiii_plate_cuirass_tassets",
            new KHChestplateAccessory(new Item.Properties().stacksTo(1).defaultDurability(780), Ingredient.of(Items.GOLD_INGOT)));
    Item XIIII_PLATE_BREASTPLATE = registerItem("xiiii_plate_breastplate",
            new KHChestplateAccessory(new Item.Properties().stacksTo(1).defaultDurability(650), Ingredient.of(Items.IRON_INGOT)));
    Item DARK_XIIII_PLATE_BREASTPLATE = registerItem("dark_xiiii_plate_breastplate",
            new KHChestplateAccessory(new Item.Properties().stacksTo(1).defaultDurability(715), Ingredient.of(Items.IRON_INGOT)));
    Item GOLDEN_XIIII_PLATE_BREASTPLATE = registerItem("golden_xiiii_plate_breastplate",
            new KHChestplateAccessory(new Item.Properties().stacksTo(1).defaultDurability(780), Ingredient.of(Items.GOLD_INGOT)));

    Item BARBUTE = registerItem("barbute",
            new KHHelmetAccessory(new Item.Properties().stacksTo(1).defaultDurability(109), Ingredient.of(Items.IRON_INGOT)));
    Item DARK_BARBUTE = registerItem("dark_barbute",
            new KHHelmetAccessory(new Item.Properties().stacksTo(1).defaultDurability(120), Ingredient.of(Items.IRON_INGOT)));
    Item GOLDEN_BARBUTE = registerItem("golden_barbute",
            new KHHelmetAccessory(new Item.Properties().stacksTo(1).defaultDurability(131), Ingredient.of(Items.GOLD_INGOT)));
    Item BASCINET = registerItem("bascinet",
            new KHHelmetAccessory(new Item.Properties().stacksTo(1).defaultDurability(109), Ingredient.of(Items.IRON_INGOT)));
    Item DARK_BASCINET = registerItem("dark_bascinet",
            new KHHelmetAccessory(new Item.Properties().stacksTo(1).defaultDurability(120), Ingredient.of(Items.IRON_INGOT)));
    Item GOLDEN_BASCINET = registerItem("golden_bascinet",
            new KHHelmetAccessory(new Item.Properties().stacksTo(1).defaultDurability(131), Ingredient.of(Items.GOLD_INGOT)));
    Item KETTLE_HELM = registerItem("kettle_helm",
            new KHHelmetAccessory(new Item.Properties().stacksTo(1).defaultDurability(109), Ingredient.of(Items.IRON_INGOT)));
    Item DARK_KETTLE_HELM = registerItem("dark_kettle_helm",
            new KHHelmetAccessory(new Item.Properties().stacksTo(1).defaultDurability(120), Ingredient.of(Items.IRON_INGOT)));
    Item GOLDEN_KETTLE_HELM = registerItem("golden_kettle_helm",
            new KHHelmetAccessory(new Item.Properties().stacksTo(1).defaultDurability(131), Ingredient.of(Items.GOLD_INGOT)));
    Item NASAL_HELM = registerItem("nasal_helm",
            new KHHelmetAccessory(new Item.Properties().stacksTo(1).defaultDurability(109), Ingredient.of(Items.IRON_INGOT)));
    Item DARK_NASAL_HELM = registerItem("dark_nasal_helm",
            new KHHelmetAccessory(new Item.Properties().stacksTo(1).defaultDurability(120), Ingredient.of(Items.IRON_INGOT)));
    Item GOLDEN_NASAL_HELM = registerItem("golden_nasal_helm",
            new KHHelmetAccessory(new Item.Properties().stacksTo(1).defaultDurability(131), Ingredient.of(Items.GOLD_INGOT)));
    Item VIKING_HELM = registerItem("viking_helm",
            new KHHelmetAccessory(new Item.Properties().stacksTo(1).defaultDurability(109), Ingredient.of(Items.IRON_INGOT)));
    Item DARK_VIKING_HELM = registerItem("dark_viking_helm",
            new KHHelmetAccessory(new Item.Properties().stacksTo(1).defaultDurability(120), Ingredient.of(Items.IRON_INGOT)));
    Item GOLDEN_VIKING_HELM = registerItem("golden_viking_helm",
            new KHHelmetAccessory(new Item.Properties().stacksTo(1).defaultDurability(131), Ingredient.of(Items.GOLD_INGOT)));
    Item BURGONET = registerItem("burgonet",
            new KHHelmetAccessory(new Item.Properties().stacksTo(1).defaultDurability(109), Ingredient.of(Items.IRON_INGOT)));
    Item DARK_BURGONET = registerItem("dark_burgonet",
            new KHHelmetAccessory(new Item.Properties().stacksTo(1).defaultDurability(120), Ingredient.of(Items.IRON_INGOT)));
    Item GOLDEN_BURGONET = registerItem("golden_burgonet",
            new KHHelmetAccessory(new Item.Properties().stacksTo(1).defaultDurability(131), Ingredient.of(Items.GOLD_INGOT)));

    Item ARMET = registerItem("armet",
            new KHHelmetAccessory(new Item.Properties().stacksTo(1).defaultDurability(172), true, Ingredient.of(Items.IRON_INGOT)));
    Item DARK_ARMET = registerItem("dark_armet",
            new KHHelmetAccessory(new Item.Properties().stacksTo(1).defaultDurability(189), true, Ingredient.of(Items.IRON_INGOT)));
    Item GOLDEN_ARMET = registerItem("golden_armet",
            new KHHelmetAccessory(new Item.Properties().stacksTo(1).defaultDurability(206), true, Ingredient.of(Items.GOLD_INGOT)));
    Item ARMET_2 = registerItem("armet_2",
            new KHHelmetAccessory(new Item.Properties().stacksTo(1).defaultDurability(172), true, Ingredient.of(Items.IRON_INGOT)));
    Item DARK_ARMET_2 = registerItem("dark_armet_2",
            new KHHelmetAccessory(new Item.Properties().stacksTo(1).defaultDurability(189), true, Ingredient.of(Items.IRON_INGOT)));
    Item GOLDEN_ARMET_2 = registerItem("golden_armet_2",
            new KHHelmetAccessory(new Item.Properties().stacksTo(1).defaultDurability(206), true, Ingredient.of(Items.GOLD_INGOT)));
    Item VISORED_BARBUTE = registerItem("visored_barbute",
            new KHHelmetAccessory(new Item.Properties().stacksTo(1).defaultDurability(172), true, Ingredient.of(Items.IRON_INGOT)));
    Item DARK_VISORED_BARBUTE = registerItem("dark_visored_barbute",
            new KHHelmetAccessory(new Item.Properties().stacksTo(1).defaultDurability(189), true, Ingredient.of(Items.IRON_INGOT)));
    Item GOLDEN_VISORED_BARBUTE = registerItem("golden_visored_barbute",
            new KHHelmetAccessory(new Item.Properties().stacksTo(1).defaultDurability(206), true, Ingredient.of(Items.GOLD_INGOT)));
    Item HOUNDSKULL = registerItem("houndskull",
            new KHHelmetAccessory(new Item.Properties().stacksTo(1).defaultDurability(172), true, Ingredient.of(Items.IRON_INGOT)));
    Item DARK_HOUNDSKULL = registerItem("dark_houndskull",
            new KHHelmetAccessory(new Item.Properties().stacksTo(1).defaultDurability(189), true, Ingredient.of(Items.IRON_INGOT)));
    ...
    Item DARK_SALLET = registerItem("dark_sallet",
            new KHHelmetAccessory(new Item.Properties().stacksTo(1).defaultDurability(189), true, Ingredient.of(Items.IRON_INGOT)));
    Item GOLDEN_SALLET = registerItem("golden_sallet",
            new KHHelmetAccessory(new Item.Properties().stacksTo(1).defaultDurability(206), true, Ingredient.of(Items.GOLD_INGOT)));
    Item BURGONET_FALLING_BUFFE = registerItem("burgonet_falling_buffe",
            new KHHelmetAccessory(new Item.Properties().stacksTo(1).defaultDurability(172), true, Ingredient.of(Items.IRON_INGOT)));
    Item DARK_BURGONET_FALLING_BUFFE = registerItem("dark_burgonet_falling_buffe",
            new KHHelmetAccessory(new Item.Properties().stacksTo(1).defaultDurability(189), true, Ingredient.of(Items.IRON_INGOT)));
    Item GOLDEN_BURGONET_FALLING_BUFFE = registerItem("golden_burgonet_falling_buffe",
            new KHHelmetAccessory(new Item.Properties().stacksTo(1).defaultDurability(206), true, Ingredient.of(Items.GOLD_INGOT)));
    Item CLOSE_HELM = registerItem("close_helm",
            new KHCloseHelmet(new Item.Properties().stacksTo(1).defaultDurability(172), true, Ingredient.of(Items.IRON_INGOT)));
    Item DARK_CLOSE_HELM = registerItem("dark_close_helm",
            new KHCloseHelmet(new Item.Properties().stacksTo(1).defaultDurability(189), true, Ingredient.of(Items.IRON_INGOT)));
    Item GOLDEN_CLOSE_HELM = registerItem("golden_close_helm",
            new KHCloseHelmet(new Item.Properties().stacksTo(1).defaultDurability(206), true, Ingredient.of(Items.GOLD_INGOT)));

    Item FROGMOUTH = registerItem("frogmouth",
            new KHHelmetAccessory(new Item.Properties().stacksTo(1).defaultDurability(354), Ingredient.of(Items.IRON_INGOT)));
    Item DARK_FROGMOUTH = registerItem("dark_frogmouth",
            new KHHelmetAccessory(new Item.Properties().stacksTo(1).defaultDurability(389), Ingredient.of(Items.IRON_INGOT)));
    Item GOLDEN_FROGMOUTH = registerItem("golden_frogmouth",
            new KHHelmetAccessory(new Item.Properties().stacksTo(1).defaultDurability(425), Ingredient.of(Items.GOLD_INGOT)));
    Item GREAT_ARMET = registerItem("great_armet",
            new KHHelmetAccessory(new Item.Properties().stacksTo(1).defaultDurability(234), true, Ingredient.of(Items.IRON_INGOT)));
    Item DARK_GREAT_ARMET = registerItem("dark_great_armet",
            new KHHelmetAccessory(new Item.Properties().stacksTo(1).defaultDurability(257), true, Ingredient.of(Items.IRON_INGOT)));
    Item GOLDEN_GREAT_ARMET = registerItem("golden_great_armet",
            new KHHelmetAccessory(new Item.Properties().stacksTo(1).defaultDurability(281), true, Ingredient.of(Items.GOLD_INGOT)));
    Item GREAT_ARMET_2 = registerItem("great_armet_2",
            new KHHelmetAccessory(new Item.Properties().stacksTo(1).defaultDurability(234), true, Ingredient.of(Items.IRON_INGOT)));
    Item DARK_GREAT_ARMET_2 = registerItem("dark_great_armet_2",
            new KHHelmetAccessory(new Item.Properties().stacksTo(1).defaultDurability(257), true, Ingredient.of(Items.IRON_INGOT)));
    Item GOLDEN_GREAT_ARMET_2 = registerItem("golden_great_armet_2",
            new KHHelmetAccessory(new Item.Properties().stacksTo(1).defaultDurability(281), true, Ingredient.of(Items.GOLD_INGOT)));
    Item GREAT_BASCINET = registerItem("great_bascinet",
            new KHHelmetAccessory(new Item.Properties().stacksTo(1).defaultDurability(234), true, Ingredient.of(Items.IRON_INGOT)));
    Item DARK_GREAT_BASCINET = registerItem("dark_great_bascinet",
            new KHHelmetAccessory(new Item.Properties().stacksTo(1).defaultDurability(257), true, Ingredient.of(Items.IRON_INGOT)));
    Item GOLDEN_GREAT_BASCINET = registerItem("golden_great_bascinet",
            new KHHelmetAccessory(new Item.Properties().stacksTo(1).defaultDurability(281), true, Ingredient.of(Items.GOLD_INGOT)));
    Item GREAT_HOUNDSKUL_BASCINET = registerItem("great_houndskul_bascinet",
            new KHHelmetAccessory(new Item.Properties().stacksTo(1).defaultDurability(234), true, Ingredient.of(Items.IRON_INGOT)));
    Item DARK_GREAT_HOUNDSKUL_BASCINET = registerItem("dark_great_houndskul_bascinet",
            new KHHelmetAccessory(new Item.Properties().stacksTo(1).defaultDurability(257), true, Ingredient.of(Items.IRON_INGOT)));
    Item GOLDEN_GREAT_HOUNDSKUL_BASCINET = registerItem("golden_great_houndskul_bascinet",
            new KHHelmetAccessory(new Item.Properties().stacksTo(1).defaultDurability(281), true, Ingredient.of(Items.GOLD_INGOT)));
    Item MAXIMILLIAN_HELMET = registerItem("maximillian_helmet",
            new KHHelmetAccessory(new Item.Properties().stacksTo(1).defaultDurability(234), true, Ingredient.of(Items.IRON_INGOT)));
    Item DARK_MAXIMILLIAN_HELMET = registerItem("dark_maximillian_helmet",
            new KHHelmetAccessory(new Item.Properties().stacksTo(1).defaultDurability(257), true, Ingredient.of(Items.IRON_INGOT)));
    Item GOLDEN_MAXIMILLIAN_HELMET = registerItem("golden_maximillian_helmet",
            new KHHelmetAccessory(new Item.Properties().stacksTo(1).defaultDurability(281), true, Ingredient.of(Items.GOLD_INGOT)));
    Item SAVOYARD = registerItem("savoyard",
            new KHSavoyard(new Item.Properties().stacksTo(1).defaultDurability(234), true, Ingredient.of(Items.IRON_INGOT)));
    Item DARK_SAVOYARD = registerItem("dark_savoyard",
            new KHSavoyard(new Item.Properties().stacksTo(1).defaultDurability(257), true, Ingredient.of(Items.IRON_INGOT)));
    Item GOLDEN_SAVOYARD = registerItem("golden_savoyard",
            new KHSavoyard(new Item.Properties().stacksTo(1).defaultDurability(281), true, Ingredient.of(Items.GOLD_INGOT)));

    Item GAUNTLET = registerItem("gauntlet",
            new KHChestplateAccessory(new Item.Properties().stacksTo(1).defaultDurability(90), Ingredient.of(Items.IRON_INGOT)));
    Item DARK_GAUNTLET = registerItem("dark_gauntlet",
            new KHChestplateAccessory(new Item.Properties().stacksTo(1).defaultDurability(99), Ingredient.of(Items.IRON_INGOT)));
    Item GOLDEN_GAUNTLET = registerItem("golden_gauntlet",
            new KHChestplateAccessory(new Item.Properties().stacksTo(1).defaultDurability(108), Ingredient.of(Items.GOLD_INGOT)));
    Item BRIGANDINE_HARNESS = registerItem("brigandine_harness",
    ...
    Item DARK_BRIGANDINE_HARNESS = registerItem("dark_brigandine_harness",
    ...
    Item GOLDEN_BRIGANDINE_HARNESS = registerItem("golden_brigandine_harness",
    ...
    Item DARK_BRIGANDINE_CUISSES = registerItem("dark_brigandine_cuisses",
    ...
    Item GOLDEN_BRIGANDINE_CUISSES = registerItem("golden_brigandine_cuisses",
    ...
    Item PLATE_CUISSES = registerItem("plate_cuisses",
            new KHLeggingsAccessory(new Item.Properties().stacksTo(1).defaultDurability(203), Ingredient.of(Items.IRON_INGOT)));
    Item DARK_PLATE_CUISSES = registerItem("dark_plate_cuisses",
            new KHLeggingsAccessory(new Item.Properties().stacksTo(1).defaultDurability(223), Ingredient.of(Items.IRON_INGOT)));
    Item GOLDEN_PLATE_CUISSES = registerItem("golden_plate_cuisses",
            new KHLeggingsAccessory(new Item.Properties().stacksTo(1).defaultDurability(244), Ingredient.of(Items.GOLD_INGOT)));

    Item GREAVES = registerItem("greaves",
            new KHLeggingsAccessory(new Item.Properties().stacksTo(1).defaultDurability(90), Ingredient.of(Items.IRON_INGOT)));
    Item DARK_GREAVES = registerItem("dark_greaves",
            new KHLeggingsAccessory(new Item.Properties().stacksTo(1).defaultDurability(99), Ingredient.of(Items.IRON_INGOT)));
    Item GOLDEN_GREAVES = registerItem("golden_greaves",
            new KHLeggingsAccessory(new Item.Properties().stacksTo(1).defaultDurability(108), Ingredient.of(Items.GOLD_INGOT)));

    Item SABATONS = registerItem("sabatons",
            new KHBootsAccessory(new Item.Properties().stacksTo(1).defaultDurability(90), Ingredient.of(Items.IRON_INGOT)));
    Item DARK_SABATONS = registerItem("dark_sabatons",
            new KHBootsAccessory(new Item.Properties().stacksTo(1).defaultDurability(99), Ingredient.of(Items.IRON_INGOT)));
    Item GOLDEN_SABATONS = registerItem("golden_sabatons",
            new KHBootsAccessory(new Item.Properties().stacksTo(1).defaultDurability(108), Ingredient.of(Items.GOLD_INGOT)));

    Item BEVOR = registerItem("bevor",
            new KHBevor(new Item.Properties().stacksTo(1).defaultDurability(100), Ingredient.of(Items.IRON_INGOT)));
    Item DARK_BEVOR = registerItem("dark_bevor",
            new KHBevor(new Item.Properties().stacksTo(1).defaultDurability(110), Ingredient.of(Items.IRON_INGOT)));
    Item GOLDEN_BEVOR = registerItem("golden_bevor",
            new KHBevor(new Item.Properties().stacksTo(1).defaultDurability(120), Ingredient.of(Items.GOLD_INGOT)));
    Item AVENTAIL = registerItem("aventail",
            new KHChestplateAccessory(new Item.Properties().stacksTo(1).defaultDurability(120), Ingredient.of(Items.IRON_INGOT)));

    Item RIM_GUARDS = registerItem("rim_guards", new Item(new Item.Properties().stacksTo(1)));

    Item BESAGEWS = registerItem("besagews", new Item(new Item.Properties().stacksTo(1)));

    Item SURCOAT = registerItem("surcoat",
            new KHDyeableChestplateAccessory(new Item.Properties().stacksTo(1), Ingredient.of(Items.LEATHER)));
    Item SURCOAT_SLEEVELESS = registerItem("surcoat_sleeveless",
            new KHDyeableChestplateAccessory(new Item.Properties().stacksTo(1), Ingredient.of(Items.LEATHER)));
    Item CIVILIAN_SURCOAT = registerItem("civilian_surcoat",
            new KHDyeableChestplateAccessory(new Item.Properties().stacksTo(1), Ingredient.of(Items.LEATHER)));
    Item GIORNEA = registerItem("giornea",
            new KHDyeableChestplateAccessory(new Item.Properties().stacksTo(1), Ingredient.of(Items.LEATHER)));

    Item CLOAK = registerItem("cloak",
            new KHCloak(new Item.Properties().stacksTo(1)));
    Item TORN_CLOAK = registerItem("torn_cloak",
            new KHCloak(new Item.Properties().stacksTo(1)));

    Item HOOD = registerItem("hood",
            new KHCloak(new Item.Properties().stacksTo(1)));
    Item TORN_HOOD = registerItem("torn_hood",
            new KHCloak(new Item.Properties().stacksTo(1)));
    Item JESTER_HOOD = registerItem("jester_hood",
            new KHCloak(new Item.Properties().stacksTo(1), true));
    Item HELMET_HOOD = registerItem("helmet_hood",
            new KHCloak(new Item.Properties().stacksTo(1)));
    Item HELMET_TORN_HOOD = registerItem("helmet_torn_hood",
            new KHCloak(new Item.Properties().stacksTo(1)));

    Item LONGBOW = registerItem("longbow",
            new Item(new Item.Properties().stacksTo(1).defaultDurability(666)));

    Item HEAVY_CROSSBOW = registerItem("heavy_crossbow",
            new HeavyCrossbow(new Item.Properties().stacksTo(1).defaultDurability(666)));

    Item ARQUEBUS = registerItem("arquebus",
            new Arquebus(new Item.Properties().stacksTo(1).defaultDurability(666)));

    Item HANDGONNE = registerItem("handgonne",
            new Handgonne(new Item.Properties().stacksTo(1).defaultDurability(666)));

    Item SWALLOWTAIL_ARROW = registerItem("swallowtail_arrow",
            new KHExtendedArrowItem(new Item.Properties(), KHSwallowTailArrowEntity::new));
    Item BODKIN_ARROW = registerItem("bodkin_arrow",
            new KHExtendedArrowItem(new Item.Properties(), KHBodkinArrowEntity::new));
    Item BROADHEAD_ARROW = registerItem("broadhead_arrow",
            new KHExtendedArrowItem(new Item.Properties(), KHBroadheadArrowEntity::new));
    Item CLOTH_ARROW = registerItem("cloth_arrow",
            new ClothArrow(new Item.Properties(), KHClothArrowEntity::new));

    Item HORSE_BARDING = registerItem("horse_barding",
            new HorseBardingArmorItem(7, new Item.Properties().stacksTo(1)));
    Item DARK_HORSE_BARDING = registerItem("dark_horse_barding",
            new HorseBardingArmorItem(7, new Item.Properties().stacksTo(1)));
    Item GOLDEN_HORSE_BARDING = registerItem("golden_horse_barding",
            new HorseBardingArmorItem(7, new Item.Properties().stacksTo(1)));

    Item PLUME = registerItem("plume",
            new DyeableItems(new Item.Properties().stacksTo(1)));
    Item TRI_PLUME = registerItem("tri_plume",
            new DyeableItems(new Item.Properties().stacksTo(1)));
    Item FLUFFY_PLUME = registerItem("fluffy_plume",
            new DyeableItems(new Item.Properties().stacksTo(1)));
    Item TORSE = registerItem("torse",
            new TwoLayerDyeableItem(new Item.Properties().stacksTo(1)));
    Item TEUTONIC_SNAKES = deco("teutonic_snakes");
    Item TEUTONIC_BLACK_SNAKES = deco("teutonic_black_snakes");
    Item GOLD_HORNS = deco("gold_horns");
    Item BLACK_HORNS = deco("black_horns");
    Item TEUTONIC_GOLD_WINGS = deco("teutonic_gold_wings");
    Item TEUTONIC_BLACK_WINGS = deco("teutonic_black_wings");
    Item TEUTONIC_WINGS_BALL_ENDS = deco("teutonic_wings_ball_ends");
    Item TEUTONIC_WINGS_SHARP_ENDS = deco("teutonic_wings_sharp_ends");
    Item DRAGON = deco("dragon");
    Item LION = deco("lion");
    Item SNAKE = deco("snake");
    Item UNICORN = deco("unicorn");
    Item STAG = deco("stag");
    Item BOAR = deco("boar");
    Item EAGLE = deco("eagle");
    Item PEGASUS = deco("pegasus");

    Item CHAPERON = registerItem("chaperon",
    ...
    private static Item registerItem(String name, Item item) {
        return Registry.register(BuiltInRegistries.ITEM, new ResourceLocation(KnightsHeraldry.MOD_ID, name), item);
    }
