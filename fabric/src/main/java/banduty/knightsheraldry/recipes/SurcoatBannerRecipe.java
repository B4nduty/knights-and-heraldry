...
public class SurcoatBannerRecipe extends CustomRecipe {
    ...
    public boolean matches(CraftingContainer container, Level level) {
        ...
        for (int i = 0; i < container.getContainerSize(); i++) {
            ...
            if (stack.is(ModItems.SURCOAT) || stack.is(ModItems.SURCOAT_SLEEVELESS)) {
                if (!surcoat.isEmpty()) return false;
                surcoat = stack;
    ...
    public ItemStack assemble(CraftingContainer container, RegistryAccess registryAccess) {
        ...
        for (int i = 0; i < container.getContainerSize(); i++) {
            ...
            if (stack.is(ModItems.SURCOAT) || stack.is(ModItems.SURCOAT_SLEEVELESS)) {
                ...
                isSleeveless = stack.is(ModItems.SURCOAT_SLEEVELESS);
            } else if (stack.getItem() instanceof BannerItem) {
                banner = stack;
            }
        }
        ...
        ItemStack result;
        if (isSleeveless) {
            result = new ItemStack(ModItems.SURCOAT_SLEEVELESS);
        } else {
            result = new ItemStack(ModItems.SURCOAT);
        }
    ...
    public RecipeSerializer<?> getSerializer() {
        return ModRecipes.SURCOAT_BANNER;
    }
}